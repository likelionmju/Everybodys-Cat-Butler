    ...
    return (
        <div id="total">
            ...
            <div id="location_btn">
                ...
                <div id="location_left_total_text">

                    <svg id="Icon_pin_left_btn" viewbox="7.875 3.375 15 21.667">
                        <path
                            d="M 15.375 3.375 C 11.234375 3.375 7.874999046325684 6.494791984558105 7.874999046325684 10.33854293823242 C 7.874999046325684 15.75520896911621 15.375 25.04166793823242 15.375 25.04166793823242 C 15.375 25.04166793823242 22.875 15.75520896911621 22.875 10.33854293823242 C 22.875 6.494791984558105 19.515625 3.375 15.375 3.375 Z M 15.375 13.31770896911621 C 14.02604198455811 13.31770896911621 12.93229198455811 12.22395896911621 12.93229198455811 10.875 C 12.93229198455811 9.526041984558105 14.02604198455811 8.432292938232422 15.375 8.432292938232422 C 16.72396087646484 8.432292938232422 17.81770896911621 9.526041984558105 17.81770896911621 10.875 C 17.81770896911621 12.22395896911621 16.72396087646484 13.31770896911621 15.375 13.31770896911621 Z"></path>
                    </svg>

                    <div id="location_left_text">
                        <span>왼쪽</span>
                    </div>

                </div>
                <input type="button" id="location_right_btn"></input>
                <div id="location_right_total_text">

                    <svg id="Icon_pin_right_btn" viewbox="7.875 3.375 15 21.667">
                        <path
                            d="M 15.375 3.375 C 11.234375 3.375 7.874999046325684 6.494791984558105 7.874999046325684 10.33854293823242 C 7.874999046325684 15.75520896911621 15.375 25.04166793823242 15.375 25.04166793823242 C 15.375 25.04166793823242 22.875 15.75520896911621 22.875 10.33854293823242 C 22.875 6.494791984558105 19.515625 3.375 15.375 3.375 Z M 15.375 13.31770896911621 C 14.02604198455811 13.31770896911621 12.93229198455811 12.22395896911621 12.93229198455811 10.875 C 12.93229198455811 9.526041984558105 14.02604198455811 8.432292938232422 15.375 8.432292938232422 C 16.72396087646484 8.432292938232422 17.81770896911621 9.526041984558105 17.81770896911621 10.875 C 17.81770896911621 12.22395896911621 16.72396087646484 13.31770896911621 15.375 13.31770896911621 Z"></path>
                    </svg>

                    <div id="location_right_text">
                        <span>오른쪽</span>
                    </div>
